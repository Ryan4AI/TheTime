...
function init(items, identity) {
  ...
  if (identity) {
    ...
    function ageMultFor(a) {
      if (age < 6) return { '声望':0.1, '财富':0.05, '学识':0.15, '颜值':1.5, '医术':0.05, '战功':0, '文采':0.05, '政绩':0, '义行':0.3 }[a] || 1.0
      if (age < 12) return { '声望':0.25, '财富':0.15, '学识':0.35, '颜值':1.4, '医术':0.15, '战功':0.15, '文采':0.25, '政绩':0.1, '义行':0.5 }[a] || 1.0
      if (age < 18) return { '声望':0.4, '财富':0.3, '学识':0.6, '颜值':1.3, '医术':0.3, '战功':0.3, '文采':0.5, '政绩':0.2, '义行':0.7 }[a] || 1.0
